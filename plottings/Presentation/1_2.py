...
plt.scatter(a.index.values, a['videocon(Vc_mean,S)'],c='#f79410',s=size*2,alpha=transparency,marker='+',label="videocon")
plt.scatter(a.index.values, a['instructblip(Vc_mean,S)'],c='#0cb14d',s=size,alpha=transparency,marker='x',label="instructblip")
plt.scatter(a.index.values, a['llava(Vc_mean,S)'],c='#145d9e',s=size*2,alpha=transparency,marker='+',label= "llava")
...
for lh in legend.legend_handles:
    lh.set_alpha(1)
plt.savefig(f'models_correlation2.png', dpi=300)
plt.clf()
